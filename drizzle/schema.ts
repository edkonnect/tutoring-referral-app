...
export const products = mysqlTable("products", {
  ...
  promoterCommission: decimal("promoterCommission", { precision: 5, scale: 2 }),
  adminCommission: decimal("adminCommission", { precision: 5, scale: 2 }),
...
// Promo codes generated by admin for parents
export const promoCodes = mysqlTable("promo_codes", {
  ...
  discount: decimal("discount", { precision: 5, scale: 2 }).default("10.00").notNull(),
